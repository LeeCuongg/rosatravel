 ...
 *
 * Ảnh nằm bên trái với tỉ lệ cố định 4/3 và `object-cover`: địa điểm được
 * chụp bằng đủ loại máy ở đủ tỉ lệ, và một hàng thẻ mà mỗi cái cao một kiểu
 * thì cả khối trông như bị vỡ. Cắt ảnh là cái giá phải trả cho việc đó.
 */
export function LocationCard({ location, locale }: { location: Location; locale: 'vi' | 'en' }) {
    ...
    >
      ...
      <div className="flex flex-col gap-2 p-4 sm:p-6">
        ...
        {/* line-clamp-2: phần tóm tắt do người nhập gõ, không có gì chặn độ dài.
            ...
            nội dung (bài đầy đủ nằm ở trang riêng của địa điểm). */}
